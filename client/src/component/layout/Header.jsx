...
import UserFormSubmit from "../user/UserFormSubmit.jsx";
...
const Header = () => {
    ...
    const {UserLogoutRequest,isLogin} = UserStore()
...

                    {
                        isLogin() ? (
                            ...
                            <Link type="button" className="btn ms-3 btn-success d-flex" to="/profile">
                                ...
                                <UserFormSubmit onClick={onLogout} text="Logout" className="btn ms-3 btn-success d-flex"/>
                            </>
                        ):(
                            <>
